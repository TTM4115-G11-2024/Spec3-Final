...
accped_users = {
    "Adrian": ["18:00", "20:00"],"Sindre":["13:45"]
}
...
error_to_idle={"trigger": "error_resolved",
    "source": "error",
    "target": "idle",
    }
idle_to_error={"trigger": "error_occur",
    "source": "idle",
    "target": "error",
    }
        
connected_to_error={"trigger": "error_occur",
    "source": "connected",
    "target": "error",
    }

charging_to_error={"trigger": "error_occur",
    "source": "charging",
    "target": "error",
    }
charger = Charger()

charger_machine = Machine(transitions=[idle_to_connected,connected_to_charging,connected_to_idle,charging_to_idle,error_to_idle,idle_to_error,charging_to_error,connected_to_error], obj=charger, name="charging_the_car")
driver = Driver()
